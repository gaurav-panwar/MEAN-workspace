...
userList.push(new User({ provider: 'local', name: 'aditya', email: 'aditya@example.com', password: '123'}) );
userList.push(new User({ provider: 'local', name: 'gaurav', email: 'gaurav@example.com', password: '123'}) );
userList.push(new User({ provider: 'local', name: 'nikesh', email: 'nikesh@example.com', password: '123'}) );
userList.push(new User({ provider: 'local', name: 'parveen', email: 'parveen@example.com', password: '123'}) );
userList.push(new User({ provider: 'local', name: 'ahmar', email: 'ahmar@example.com', password: '123'}) );
userList.push(new User({ provider: 'local', name: 'shubh', email: 'shubh@example.com', password: '123'}) );
userList.push(new User({ provider: 'local', name: 'mohini', email: 'mohini@example.com', password: '123'}) );
userList.push(new User({ provider: 'local', name: 'komal', email: 'komal@example.com', password: '123'}) );
userList.push(new User({ provider: 'local', name: 'aarushi', email: 'aarushi@example.com', password: '123'}) );
userList.push(new User({ provider: 'local', name: 'yogita', email: 'yogita@example.com', password: '123'}) );
userList.push(new User({ provider: 'local', name: 'ankita', email: 'ankita@example.com', password: '123'}) );
userList.push(new User({ provider: 'local', name: 'divya', email: 'divya@example.com', password: '123'}) );
userList.push(new User({ provider: 'local', name: 'priyanka', email: 'priyanka@example.com', password: '123'}) );
userList.push(new User({ provider: 'local', name: 'luv', email: 'luv@example.com', password: '123'}) );
userList.push(new User({ provider: 'local', name: 'atul', email: 'atul@example.com', password: '123'}) );
userList.push(new User({ provider: 'local', name: 'yogendra', email: 'yogendra@example.com', password: '123'}) );
...
each team has 2 Channels, One Public and One Private */
var channelList = [];

channelList.push(new Channel ({ name: 'public', members: [userList[1]._id, userList[2]._id, userList[3]._id, userList[4]._id] }) );
channelList.push(new Channel ({ name: 'private', members: [userList[1]._id, userList[2]._id, userList[3]._id]}) );

channelList.push(new Channel ({ name: 'public', members: [userList[5]._id, userList[6]._id, userList[7]._id, userList[8]._id] }) );
channelList.push(new Channel ({ name: 'private', members: [userList[5]._id, userList[6]._id, userList[7]._id] }) );

channelList.push(new Channel ({ name: 'public', members: [userList[9]._id, userList[10]._id, userList[11]._id, userList[12]._id] }) );
channelList.push(new Channel ({ name: 'private', members: [userList[9]._id, userList[10]._id, userList[11]._id] }) );

channelList.push(new Channel ({ name: 'public', members: [userList[13]._id, userList[14]._id, userList[15]._id, userList[16]._id] }) );
...
for(var i=0; i<teamList.length; ++i) {
	orgList[i/2].teams.push(teamList[i]._id);
}


/*Push Teams into Channels*/
for(var i=0; i<channelList.length ; ++i) {
	channelList[i].team = teamList[i/2]._id;
}


/*	Pushing Teams and Channels into Users */
for(var i=1; i<userList.length; ++i) {
	userList[i].teams.push(teamList[(i-1)/4]._id);
}
